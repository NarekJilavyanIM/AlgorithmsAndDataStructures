...
def run_passed_data_structure(data_structure):
    print(UTILS.log_for_data_structure_test_start.format(data_structure=data_structure))
...
def run_passed_sorting_algorithm(algorithm):
    ...
    command = sorting_algorithm_info[UTILS.command_key].format(algorithm=algorithm)
    os.system(command)
